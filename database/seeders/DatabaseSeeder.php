...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'name' => 'Nila Marinasi Kecap Manis [250gr]',
            ...
            [
                'name' => 'Kakap Marinasi Saus Tiram [500gr]',
            ...
            [
                'name' => 'Bandeng Marinasi Bumbu Jawa [500gr]',
            ...
            [
                ...
                'description' => '[Pre Order] dikirim besok pagi',
                'price' => 9000,
                'image' => 'lele-marinasi.png',
                'stock' => 100,
                'is_active' => true,
            ],
            [
                'name' => 'Lele Segar [250gr]',
                'description' => 'Ikan lele segar pilihan',
                'price' => 6000,
                'image' => 'lele.jpg',
                'stock' => 100,
                'is_active' => true,
