        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                    <p class="text-red-600 text-sm font-medium">Link pembayaran tidak tersedia. Silakan hubungi kami.</p>
                </div>
                @endif
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div><span class="text-gray-400">No. HP</span><p class="font-semibold">{{ $order->phone }}</p></div>
                    <div class="col-span-2"><span class="text-gray-400">Alamat</span><p class="font-semibold">{{ $order->address }}</p></div>
                    ...
                    <div class="col-span-2">
                        ...
                        <a href="https://www.google.com/maps?q={{ $order->latitude }},{{ $order->longitude }}"
                           ...
                           class="inline-flex items-center gap-1 mt-1 text-xs text-blue-600 hover:underline">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5S10.62 6.5 12 6.5s2.5 1.12 2.5 2.5S13.38 11.5 12 11.5z"/></svg>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-4 pb-3 border-b border-gray-50 last:border-0 last:pb-0">
                        <img src="{{ $item->product->image_url }}" class="w-14 h-14 object-cover rounded-xl flex-shrink-0"
