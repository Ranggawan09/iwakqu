                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold text-sm mb-1">
                                ...
                                <span class="ml-1 text-[10px] sm:text-xs font-normal text-green-600 bg-green-50 border border-green-200 px-2 py-0.5 rounded-full inline-block mt-1 sm:mt-0">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100 sticky top-24">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-3 py-2 border-b border-gray-50 last:border-0">
                            ...
                            <p class="font-bold text-gray-900 text-sm sm:text-base whitespace-nowrap">{{ $cart->formatted_subtotal }}</p>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div id="shipping-estimate-panel" class="mt-4 hidden">
                        <div class="border border-dashed border-green-300 bg-green-50 rounded-xl p-3 space-y-1.5">
                            <div class="flex justify-between items-center text-sm">
                                ...
                                <span class="font-bold text-green-700 mt-1 sm:mt-0 whitespace-nowrap text-right" id="shipping-cost-display"></span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="font-black text-gray-900 text-sm">Subtotal</span>
                                <span class="font-bold text-gray-800 text-sm whitespace-nowrap">Rp {{ number_format($total, 0, ',', '.') }}</span>
                            </div>
                            <div class="border-t border-green-200 pt-1.5 flex justify-between items-center">
                                ...
                                <span class="font-black text-green-700 text-lg whitespace-nowrap" id="grand-total-display">Rp {{ number_format($total, 0, ',', '.') }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="normal-total-block" class="bg-green-50 rounded-xl p-3 sm:p-4 mt-4">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1 sm:gap-0">
                            <span class="font-black text-gray-900 text-sm sm:text-lg">Total Pembayaran</span>
                            <span class="font-black text-green-700 text-xl sm:text-2xl">Rp {{ number_format($total, 0, ',', '.') }}</span>
                        </div>
                    </div>
